...
parser.add_argument('--word', default='', help='search word')
parser.add_argument('--word-2', default='', help='additional search word')
parser.add_argument('--word-3', default='', help='additional search word')
parser.add_argument("--save-dir", default="./images/", help="savedir")
args = parser.parse_args()
#print("serch word = " + args.word + " " + args.word_2 + " " + args.word_3)
print("save directry = " + args.save_dir)

if not args.word_2 and args.word_3:
    print("serch word = ",args.word)
    word = args.word
    save_dir = args.save_dir + word  # スクレイピングした画像を保存するディレクトリパス

elif not args.word_3:
